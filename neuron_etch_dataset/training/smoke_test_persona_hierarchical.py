...
=====================================
Smoke test 2-stage buat adapter persona_core. Pola sama dengan
smoke_test_system_hierarchical.py / smoke_test_media_hierarchical.py,
tapi stage2 di-resolve lewat STAGE1_TO_STAGE2_GROUP (bukan langsung
task_category).

Cara pakai:
    python smoke_test_persona_hierarchical.py \\
        --base-model-dir ./models/Qwen3.5-0.8B \\
        --adapter-dir ./adapters/persona_core_v1
"""
...
from persona_chatml import PERSONA_STAGE1_PROMPT, STAGE2_PROMPTS, CATEGORIES, STAGE1_TO_STAGE2_GROUP

# (kalimat, expected_category, expected_action, expected_target_value_or_None, expected_parameters)
TEST_CASES = [
    ("Panggilin Kaito dong.", "character_call", "call", "Kaito", {}),
    ("Beralih ke Yuki aja.", "character_switch", "switch", "Yuki", {}),

    ("Ngobrol sama Rei soal kucing peliharaan.", "conversation", "talk", "Rei", {"topic": "kucing peliharaan"}),
    ("Tanyain Nova tentang startup idea.", "conversation", "ask", "Nova", {"topic": "startup idea"}),

    ("Minta Sena cerita soal traveling dong.", "topic_extraction", "talk", "Sena", {"topic": "traveling"}),

    ("Kiro, jadiin dirimu guru matematika aku.", "roleplay_intent", "roleplay", "Kiro", {"role": "guru matematika"}),

    ("Terusin percakapan tadi.", "dialogue_control", "continue", "current", {}),
    ("Kembaliin ke pembahasan awal.", "dialogue_control", "resume_topic", "previous", {}),

    ("Bilangin ke dia soal itu deh.", "context_dependency", None, None, {}),
    ("Minta yang itu jelasin.", "ambiguous", None, None, {}),

    ("Apa itu blockchain?", "negative", None, None, {}),
    ("Kenapa quantum computing itu penting?", "negative", None, None, {}),
]
...
def run_pipeline(model, tokenizer, text: str, max_new_tokens: int) -> dict:
    problems = []
    raw1 = generate(model, tokenizer, PERSONA_STAGE1_PROMPT, text, max_new_tokens=30)
